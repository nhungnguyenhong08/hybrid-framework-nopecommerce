...
public class Level_23_Grid extends BaseTest {
	...
	@BeforeClass
	public void beforeClass(String browserName, String appUrl, String osName, String ipAddress, String portNumber) {
		driver = getBrowserDriverGrid(browserName, appUrl, osName, ipAddress, portNumber);
