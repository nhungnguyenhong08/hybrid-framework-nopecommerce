...
public class Level_16_ExtendV2_Screenshot extends BaseTest {
	...
	public void User_01_Register(Method method) {
		...
		ExtentTestManager.getTest().log(LogStatus.INFO, "Register - Step 07: Enter to 'Register' button");
	...
	public void User_02_Login(Method method) {
		...
		ExtentTestManager.getTest().log(LogStatus.INFO, "Login - Step 06: Navigate to 'My Account' link");
