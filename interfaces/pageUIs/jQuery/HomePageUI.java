...
public class HomePageUI {
	public static final String PAGINAION_PAGE_BY_NUMBER = "xpath=//li[@class='qgrd-pagination-page']//a[text()='%s']";
	...
	public static final String PAGINAION_PAGE_ACTIVED_BY_NUMBER = "xpath=//li[@class='qgrd-pagination-page']//a[@class='qgrd-pagination-page-link active' and text()='%s']";
	...
	// Index của cái cột mà mình cần enter/select/click vào
