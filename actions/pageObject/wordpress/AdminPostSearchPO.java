...
public class AdminPostSearchPO extends BasePage {
	...
	public void enterToSearchTextbox(String postTitle) {
		waitForElementVisible(driver, AdminPostSearchPageUI.SEARCH_POST_TEXBOX, postTitle);
		sendkeyToElement(driver, AdminPostSearchPageUI.SEARCH_POST_TEXBOX, postTitle);
	}
